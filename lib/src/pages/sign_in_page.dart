...
class _SignInPageState extends State<SignInPage> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      // ✅ No navigation here. Your AuthGate will auto-route to HomePage.
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return _AuroraAuthShell(
      ...
      title: 'Welcome back',
      subtitle: 'Pick up where you left off—clean and focused.',
      child: Form(
        key: _formKey,
        child: Column(
          children: [
            ...
            // Small “hint” line
            Text(
              'Tip: Your session stays logged in until you logout.',
              style: TextStyle(
